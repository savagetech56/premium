...
echo -e "  Pembuat : ${green} TOXIC࿐® ${NC}"
echo -e "  Recode By My Self savage࿐ ${YELLOW}(${NC} 2025 ${YELLOW})${NC}"
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
sleep 2
###### IZIN SC 
...
function base_package() {
    clear
    ########
    print_install "install Packet Yang Dibutuhkan"
...
echo -e " ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e " \e[1;32m1)\e[0m imput your Domain (Recommended)"
...
URL="https://api.telegram.org/bot$KEY/sendMessage"
    ...
    TEXT="Instalasi Autoscript-free V4.0
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
function pasang_ssl() {
clear
print_install "setting SSL for Domain"
...
bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh)" @ install -u www-data --version $latest_version
    ...
    print_install "setting Configuration Packet"
...
function ssh(){
clear
print_install "Setting Password SSH"
...
function ins_backup(){
clear
print_install "Setting Backup Server"
#BackupOption
